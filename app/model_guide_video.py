...
def get_vguide_video(video_name_search):
    ...
    try:
        with conn.cursor() as cursor:
            ...
            # 添加视频名称模糊查询条件
            if video_name_search is not None and video_name_search.strip() != '':
                sql_conditions.append("video_name LIKE %s")
                query_params.append(f"%{video_name_search}%")
